...
const Settings = () => {
  ...
  console.log('profiles from state', profiles)
  ...
  useEffect(() => {
    // dispatch(getProfilesByUser({ search: user?.result?._id || user?.result.jti}))
      ...
      <Paper className={classes.paper} elevation={1} >
        ...
        <form className={classes.form} onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            ...
            <Input name="paymentDetails" label="Payment Details/Notes" handleChange={handleChange} type="text" multiline minRows="4" value={form?.paymentDetails} />
          </Grid>
